...
public class event_details3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_detail3);

        button = (TextView) findViewById(R.id.attendButton3);
        button.setOnClickListener(this);
    }

    public void onClick(View view) {
        switch (view.getId()){
            case R.id.attendButton3:
                addAttendee();
                break;
        }
    }
