...
public class event_details4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_detail4);

        button = (TextView) findViewById(R.id.attendButton4);
        button.setOnClickListener(this);
    }

    public void onClick(View view) {
        switch (view.getId()){
            case R.id.attendButton4:
                addAttendee();
                break;
        }
    }
